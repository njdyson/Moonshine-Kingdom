...
- **Disqualification is short-lived.** Rise is one Play (Boss into any Safe Ward). Square Up is
...
- **The Almanac already teaches the late hit.** Lesson 32: post the bounty late, when the leader
...
- **Town Planner** quick reference and the **Federal Crackdown Tracker** strip (its "race for 40"
  line).
- **The Almanac**: lessons 15, 31 and 32 are built on crossing 20 as the finish. Rewrite the
