...
It is a special, one-time Play that the Nod unlocks, so it lives on the Winning the Game page (in
its own Plays-style table) and on the Nod card. Keep it out of the standard Power Plays table
